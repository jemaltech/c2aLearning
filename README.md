...
This application is a demonstration application of the generator: generator-jhipster-paypal.

You can buy an item and pay for it by paypal.

## Screenshots

![product](images/chien.png)
...
To optimize the PaypalSampleApp application for production, run:
